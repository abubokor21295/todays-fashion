                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="admin/img/<?php echo $product->photo ?>" data-zoom-image="admin/img/<?php echo $product->photo ?>" alt="product image">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href="#" data-image="admin/img/<?php echo $product->photo ?>" data-zoom-image="admin/img/<?php echo $product->photo ?>">
                                                <img src="admin/img/<?php echo $product->photo ?>" alt="product side">
                                            </a>

                                            <a class="product-gallery-item" href="#" data-image="admin/img/<?php echo $product->photo ?>" data-zoom-image="admin/img/<?php echo $product->photo ?>">
                                                <img src="admin/img/<?php echo $product->photo ?>" alt="product cross">
                                            </a>
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title"><?php echo $product->name ?></h1><!-- End .product-title -->
                                    ...
                                    <div class="product-price">
                                        Offer Price: <?php echo $product->offer_price ?>
                                    </div><!-- End .product-price -->
                                    <div class="product-price">
                                       Regular Price: <s><?php echo $product->regular_price ?></s></div>
