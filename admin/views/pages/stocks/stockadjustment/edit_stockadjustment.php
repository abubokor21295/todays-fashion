...
*/
	if(count($errors)==0){
		...
		$stockadjustment->adjustment_at=date("Y-m-d",strtotime($_POST["txtAdjustmentAt"]));
...
<?php
	...
	$html.=input_field(["label"=>"Adjustment At","type"=>"text","name"=>"txtAdjustmentAt","value"=>"$stockadjustment->adjustment_at"]);
