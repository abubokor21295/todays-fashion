...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <h1 style="color:green;"><b><em>Today's Fashion</em></b></h1>
            ...
            <h3>Update Stock_adjustment_type</h3>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">     
     <div class="card"><form class='form-horizontal' action='edit-stock-adjustment-type' method='post' enctype='multipart/form-data'><div class='card-header'>
