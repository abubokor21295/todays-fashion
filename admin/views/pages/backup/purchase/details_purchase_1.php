            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    <tr><td><b>Purchase ID:</b></td><td><input type="text" style="width:60px" value="<?php echo {$obj->get_id()};?>"  readonly/></td></tr>
                    <tr><td><b>Purchase Date:</b></td><td><input type="text" id="txtPurchaseDate" value=<?php echo {$obj->get_purchase_date()};?> /></td></tr>
                    <tr><td><b>Purchase Due Date:</b></td><td><input type="text" id="txtDueDate" value=<?php echo {$obj->get_delivery_date()};?> /></td></tr>
                  </table>
                </div>
                <!-- /.col -->
              </div>
...
<script>
      $(function() {  
        ...
        //Show supplier's other information
