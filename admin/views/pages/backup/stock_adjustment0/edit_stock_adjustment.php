...
<section class="content-header">
    ...
    <section class="content">     
     <div class="card"><form class='form-horizontal' action='edit-stock-adjustment' method='post' enctype='multipart/form-data'><div class='card-header'>
