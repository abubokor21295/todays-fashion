...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		$html="<table class='table'>";
			$html.="<tr><th colspan='3'><a class=\"btn btn-success\" href=\"create-transactiontype\">New TransactionType</a></th></tr>";
		if($action){
		...
		while($transactiontype=$result->fetch_object()){
			...
			if($action){
				...
				$action_buttons.= action_button(["id"=>$transactiontype->id, "name"=>"Details", "value"=>"Detials", "class"=>"info", "url"=>"details-transactiontype"]);
				$action_buttons.= action_button(["id"=>$transactiontype->id, "name"=>"Edit", "value"=>"Edit", "class"=>"primary", "url"=>"edit-transactiontype"]);
				$action_buttons.= action_button(["id"=>$transactiontype->id, "name"=>"Delete", "value"=>"Delete", "class"=>"danger", "url"=>"transaction_types"]);
	...
	static function html_row_details($id){
		...
		$transactiontype=$result->fetch_object();
		$html="<table class='table'>";
		$html.="<tr><th colspan=\"2\">TransactionType Details</th></tr>";
