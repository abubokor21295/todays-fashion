...
function nav_link($url,$text,$css="far fa-circle"){
   ...
   function page_header($config){
    ...
    $html.="<a href=\"javascript:void(0)\" class=\"d-flex  mb-3 mb-lg-0 me-lg-auto text-dark text-decoration-none\">";
    $html.="<span class=\"fs-4\">{$config["title"]}</span>";
    $html.="<div style=\"margin-left:200px;\">
            <h1 style=\"color:green;\"><b>Today's Fashion</b></h1>
            <address style=\"font-size: small;text-align:center\">
               <strong>Today's Fashion, Inc.</strong><br>
               House:12, Road:1, Block:E<br>
               Mobile: 017834433<br>
               Email: bokor.intels.co
            </address>
         </div>";
